...
export default {
  ...
  theme: {
  	extend: {
		fontFamily: {
			satoshi: ['Satoshi', 'sans-serif'], // Define 'font-satoshi'
		  },
  		colors: {
			fill: {
			  ...
			  orange: {
				1: "#FF9B00",     //choice orange
				25: "#FFF7ED",    // Very light orange
			  ...
			  red: {
				...
				1: "#FF0000",
           	 	...
           	 	5: "#FEEBEB",
           	 	6: "#FEF3F3",
				25: "#FEE2E2",    // Very light red
				100: "#FECACA",   // Light red
				200: "#FCA5A5",   // Light red
				300: "#F87171",   // Soft red
				400: "#EF4444",   // Bright red
				500: "#DC2626",   // Red
		  ...
		  content: {
			...
			'2xsm': '360px', // Define your custom '2xsm' breakpoint (you can change the value)
		  },
